...
const register = () => {
  ...
  return (
    <div className=' flex justify-center bg-gray-200 h-[1000px]'>
      ...
      <div className="bg-white mt-[50px] w-[500px] min-h-[644px] flex flex-col items-center gap-0.5 p-10 rounded-lg">
            ...
            <div className="w-full h-full flex rounded-[5px] overflow-hidden">
              ...
              <Col span={11.5}>
                ...
                {formik.errors.lastName && (
                  <p className='text-red-600 m-0'>{formik.errors.lastName}</p>
                )}
              </Col>
